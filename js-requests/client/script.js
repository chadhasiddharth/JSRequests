...
function changeColor() {
    ...
    // sayHelloButtonHelloButtom.classList.add("button-style");
...
sayHelloButton.addEventListener("mouseover", changeColor2)
...
// CODE HERE
function queryTest() {
    axios.get("http://localhost:3000/query-test?key=test&query=value")
    .then(response => {
        console.log(response.data)
    });
